@php
    $statement = 'В период с ' . $prevDay . ' по ' . $today . ' наша работа была ' . ($dop == 1) ? 'также' : '' . ' направлена на сбор статистики по получаемому трафику из поисковых систем, а также анализ семантического ядра:';
@endphp
